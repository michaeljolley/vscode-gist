...
export async function getSession(
  ...
  vscode.window
    .showInformationMessage(
      "Sign in to GitHub to access your GitHub Gists.",
      signInAction,
    )
    .then(
      async (result) => {
...
async function getSessionInternal(
  ...
  const authProviderId = useEnterprise()
    ? AUTH_PROVIDER_ID_ENTERPRISE
    : AUTH_PROVIDER_ID;
